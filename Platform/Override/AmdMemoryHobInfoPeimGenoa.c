...
//MU OE OVERRIDE START
  ZeroMem (&MemInitTable, sizeof(AMD_MEMORY_SUMMARY));
  ...
  */
  ...
  //Allocate memory for dynamic data
  MemInitTable.DimmPresentMap = AllocateZeroPool (sizeof(UINT32) * MemInitTable.MaxSocketSupported * MemInitTable.MaxDiePerSocket);
  MemInitTable.ChipselIntlv = AllocateZeroPool (sizeof(SIL_MEM_CFG_INFO) * MemInitTable.MaxSocketSupported * MemInitTable.MaxDiePerSocket * MemInitTable.MaxChannelPerDie);
  MemInitTable.DramEcc = AllocateZeroPool (sizeof(SIL_MEM_CFG_INFO) * MemInitTable.MaxSocketSupported * MemInitTable.MaxDiePerSocket);
  MemInitTable.DramParity = AllocateZeroPool (sizeof(SIL_MEM_CFG_INFO) * MemInitTable.MaxSocketSupported * MemInitTable.MaxDiePerSocket);
  MemInitTable.AutoRefFineGranMode = AllocateZeroPool (sizeof(SIL_MEM_CFG_INFO) * MemInitTable.MaxSocketSupported * MemInitTable.MaxDiePerSocket);
